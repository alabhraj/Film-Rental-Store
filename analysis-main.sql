/*The data has been used from a public Kaggle database and the schema was already created. These are just the queries run to achieve the aims of the project*/
